...
public class IngredientController {
    ...
    public String listIngredients(@PathVariable String recipeId, Model model){
        ...
        model.addAttribute("recipe", recipeService.findByIdDTO(Long.valueOf(recipeId)));
    ...
    public String updateRecipeIngredient(@PathVariable String recipeId,
        ...
        model.addAttribute("ingredient",ingredientService.findByRecipeIdAndIngredientId(Long.valueOf(recipeId), Long.valueOf(Long.valueOf(ingredientId))));
