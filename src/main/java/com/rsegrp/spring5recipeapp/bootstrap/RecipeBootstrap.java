package com.rsegrp.spring5recipeapp.bootstrap;

import com.rsegrp.spring5recipeapp.domain.*;
import com.rsegrp.spring5recipeapp.enums.Difficulty;
import com.rsegrp.spring5recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        UnitOfMeasure eachUom = getUnitOfMeasureOrThrowException("Each");

        UnitOfMeasure tableSpoonUom = getUnitOfMeasureOrThrowException("Tablespoon");

        UnitOfMeasure teaSpoonUom = getUnitOfMeasureOrThrowException("Teaspoon");

        UnitOfMeasure dashUom = getUnitOfMeasureOrThrowException("Dash");

        UnitOfMeasure pintUom = getUnitOfMeasureOrThrowException("Pint");

        UnitOfMeasure cupsUom = getUnitOfMeasureOrThrowException("Cup");

        //get Categories
        Category americanCategory = getCategoryOrThrowException("American");

        Category mexicanCategory = getCategoryOrThrowException("Mexican");
        ...
        guacRecipe.setSource("Nitza Villapol");
        guacRecipe.setUrl("www.nitzavillapol.com");
        ...
        tacosRecipe.setSource("Nitza Villapol");
        tacosRecipe.setUrl("www.nitzavillapol.com");
